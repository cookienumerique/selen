...
export const ComparisonFeatures = () => {
  const designationWidth = '60%';
  const featureWidth = '20%';

  const designationTextStyle: TextStyle = {
    fontSize: 14,
    fontWeight: 'bold',
    color: 'white',
  };
  const designationViewStyle: ViewStyle = {
  ...
  return (
    <ComparisonFeatureTable>
      ...
      <ComparisonFeatureRow>
        ...
        >
          <Text
            style={{ fontSize: 14, fontWeight: 'bold', color: Colors.warmSand }}
          >
            3
          </Text>
        </ComparisonFeatureCell>
        <ComparisonFeatureCell
          style={{
            width: featureWidth,
            alignItems: 'center',
            backgroundColor: 'rgba(245, 227, 200, 0.25)',
          }}
        >
          <Text
            style={{ fontSize: 16, fontWeight: 'bold', color: Colors.warmSand }}
          >
            7
          </Text>
        </ComparisonFeatureCell>
      ...
      <ComparisonFeatureRow>
        <ComparisonFeatureCell style={designationViewStyle}>
          <Text style={designationTextStyle}>
            Modification et suppression des capsules
          </Text>
        </ComparisonFeatureCell>
        <ComparisonFeatureCell
          style={{
