        ...
        >
            <SafeAreaView>
                <View style={{ padding: 16 }}>
                    ...
                    <ScrollView contentContainerStyle={{ gap: 24, paddingVertical: 32 }} showsVerticalScrollIndicator={false}>
                        <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            />
                            <Text style={{ fontSize: 24, fontWeight: 'bold', textAlign: 'center', color: Colors.linenCloud }}>Bienvenue dans l&apos;infini</Text>
                        </View>
                        <View>
