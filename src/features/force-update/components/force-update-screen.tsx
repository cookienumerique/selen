    ...
    return (
        <Container style={{ backgroundColor: Colors.slateRoot }}>
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                />
                <Text style={{ color: Colors.warmSand, fontSize: 24, textAlign: 'center', lineHeight: 40 }}>
                    Selen évolue.
                </Text>

                <Text style={{ textAlign: 'center', marginTop: 12, color: Colors.warmSand }}>
                    Pour continuer ton cheminement en toute sérénité,
                    une mise à jour est nécessaire.
                </Text>

                <Button onPress={openStore} style={{ backgroundColor: Colors.warmSand, marginTop: 'auto', width: '100%' }}>
